      ...
      <div className={styles.inner}>
        <div className={styles.header}>
          ...
          <p className="section-body">
            From our 8 acre fabrication facility in Belton, TX, we offer a full range of foam fabrication capabilities — from computerized cutting and CNC machinery to lamination, packaging, and just-in-time delivery throughout the US and Mexico.
          </p>
        </div>
